...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pylammpsmpi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pylammpsmpi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pylammpsmpi
# for installing globally
pixi global install pylammpsmpi
```
...
It is possible to list all of the versions of `pylammpsmpi` available on your platform:
...
```
pixi search pylammpsmpi --channel conda-forge
```
